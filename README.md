...
1. What are the main differences between a stateful and a functional component?
   Functional are stateless and mainly responsible for rendering user interface while Stateful implement logic and state into components.
2. When does a componentWillMount function be called? What about a componentWillUpdate?
   It is invoked immediately before mounting occurs. componentWillUpdate as soon as the shouldComponentUpdate returns true
3. Define stateful logic.
   Stateful logic is any code that uses state.
4. What are the three step of creating a successful test? What is done in each phase?
   Arrage, Render what you want to be tested. Act: find what you want to be tested in that render. Assert, Define what needs to happen in test.
